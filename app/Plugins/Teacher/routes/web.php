...
return static function (RouteCollector $r): void {
    ...
    $r->get('/teacher/questions/create-true-false', [TeacherWebController::class, 'createTrueFalse']);
    $r->get('/teacher/questions/create-drag-drop', [TeacherWebController::class, 'createDragDrop']);
    $r->get('/teacher/questions/create-case-study', [TeacherWebController::class, 'createCaseStudy']);
