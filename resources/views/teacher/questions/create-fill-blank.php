<?php
$title = 'Create FILL-BLANK Question';
ob_start();
?>
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h4 mb-1">Create Question (fill-blank)</h1>
        <p class="text-secondary mb-0">Compose and save a new fill-blank question.</p>
    </div>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form id="question-create-form" data-question-type="fill-blank" class="row g-3">
            <div class="col-12">
